...
public class PropertyCacheFileTest extends AbstractPathTestSupport {
    ...
    public void testPathToCacheContainsOnlyFileName() throws IOException {
        ...
        cache.persist();
        assertTrue("Cache file does not exist", Files7.exists(Paths.get(filePath)));
    ...
    public void testPutNonExsistingExternalResourceSameExceptionBetweenRuns() throws Exception {
        ...
        for (int i = 0; i < numberOfRuns; i++) {
            ...
            final Set<String> nonExistingExternalResources = new HashSet<String>();
    ...
    public void testChangeInConfig() throws Exception {
        ...
        details.load(Files7.newBufferedReader(new Path(cacheFile)));
        ...
        detailsAfterChangeInConfig.load(Files7.newBufferedReader(new Path(cacheFile)));
