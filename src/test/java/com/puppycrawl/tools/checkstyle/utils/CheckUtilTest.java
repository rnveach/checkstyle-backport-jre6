...
public class CheckUtilTest extends AbstractPathTestSupport {
    ...
    public void testParseDoubleIntegerValues() {
        ...
        assertEquals("Invalid parse result", Integer.parseInt("101", 2),
                CheckUtil.parseDouble("0B101", TokenTypes.NUM_INT), 0);
        assertEquals("Invalid parse result", 289775941,
        ...
        assertEquals("Invalid parse result", -2.147483648E10,
        ...
        assertEquals("Invalid parse result", 2.147483647E10,
