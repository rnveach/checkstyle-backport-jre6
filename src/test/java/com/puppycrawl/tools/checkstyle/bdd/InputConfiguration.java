...
public final class InputConfiguration {
    ...
    public DefaultConfiguration createConfiguration() {
        ...
        for (Entry<String, String> entry : nonDefaultProperties.entrySet()) {
            parsedConfig.addAttribute(entry.getKey(), entry.getValue());
        }
        return parsedConfig;
    }
    ...
    public static final class Builder {
        ...
        private final List<Integer> violations = new ArrayList<Integer>();
