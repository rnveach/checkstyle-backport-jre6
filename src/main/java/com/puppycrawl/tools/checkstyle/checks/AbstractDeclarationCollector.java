...
public abstract class AbstractDeclarationCollector extends AbstractCheck {
    ...
    public void beginTree(DetailAST rootAST) {
        final Deque<LexicalFrame> frameStack = new LinkedList<LexicalFrame>();
        frameStack.add(new GlobalFrame());

        frames = new HashMap<DetailAST, LexicalFrame>();
    ...
    private static class ClassFrame extends LexicalFrame {
        ...
        ClassFrame(LexicalFrame parent) {
            super(parent);
            instanceMembers = new HashSet<String>();
            instanceMethods = new HashSet<String>();
            staticMembers = new HashSet<String>();
            staticMethods = new HashSet<String>();
        }
